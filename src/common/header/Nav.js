...
const Nav = () => {
    return (
        <nav className="mainmenu-nav">
            ...
            <li><Link to={process.env.PUBLIC_URL + "/corporate-agency"}>Home</Link></li>

                {/* <li className="menu-item-has-children"> */}
                    {/* <Link to="#">Home <FaAngleDown /> </Link> */}
                    {/* <ul className="axil-submenu"> */}
                        {/* <li><Link to={process.env.PUBLIC_URL + "/digital-agency"}>Digital Agency</Link></li> */}
                        {/* <li><Link to={process.env.PUBLIC_URL + "/creative-agency"}>Home</Link></li> */}
                ...
                {/* <li className="menu-item-has-children">
                    ...
                    <ul className="axil-submenu">
                        ...
                        <li><Link to={process.env.PUBLIC_URL + "/service-details/design"}>Service Details</Link></li>
                                ...
                                <li><Link to={process.env.PUBLIC_URL + "/project-grid-two"}>Portfolio</Link></li>
                ...
                {/* <li className="menu-item-has-children">
                    <Link to="/about-us">About Us <FaAngleDown /></Link>
                    <ul className="axil-submenu">
